...
# タイル設置モード
  ...
  20：ガラス（一度しか通れない）、21：上左通路、22：左下通路、23：下右通路、24：右上通路、25：上下通路、26：左右通路、27：上右、左下通路、28：上左、下右通路、29：立体交差
...
# ランモード
  ...
  ゴールじゃないステージ外に出ると失敗！
  つまり、ゴール横のエリアもダメ
  あと、ネズミ同士の正面衝突や同じマスに入るのもダメ（29は"交差"はできる）
...
\>{e|ステージ名|その他}
  ...
  "e"ならアプリを終わるよ
  じゃなければ、
  ストップならタイル設置モードに戻るし、クリアならステージ名でロードできるよ
